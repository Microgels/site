  ...
  <div class="w-full mx-auto px-4 sm:px-2 xl:px-0">
    <div class="flex flex-wrap">
      <div class="flex flex-wrap -mx-4 justify-evenly gap-20 lg:w-[70%]">
        <!-- Contenu à gauche -->
        <div
          class="article-content -mb-[20%] w-full lg:w-[70%] mt-20 h-full"
        >
          <div class="-mt-24">
            <h2
              class="mb-8 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight"
              data-wow-delay="0s"
            >
              {{ $post->title }}
            </h2>
              ...
              <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-center mb-2">
                  <div class="mb-2 inline-flex items-center px-3">
                    ...
                    <p class="text-base font-medium text-body">{{$post->user->name}}</p>
                  </div>
                  <p
                    class="flex items-center text-body-color-2 dark:text-body-color"
                  >
                    <i
                      class="bi bi-calendar4 text-2xl text-[#79808A] pr-3"
                    ></i>
                ...
                <div class="wow fadeInUp" data-wow-delay=".2s">
                  <p class="mb-4 text-base text-body sm:text-right">
                    Share this post :
                  </p>
                  <div
            ...
            <div>
              ...
              <div
                class="w-full mb-10 overflow-hidden rounded-lg"
                data-wow-delay="0s"
              >
                <img
                  ...
                  alt="image",
                  loading="lazy"
                  class="object-cover object-center w-full h-96 rounded-lg"
                />
              </div>
              <div
              ...
              <blockquote
                class="wow fadeInUp relative z-10 mb-9 overflow-hidden rounded bg-[#F8FAFB] py-11 px-8  pb-24 text-center text-base text-black dark:bg-[#15182A] dark:text-white md:px-12"
              >
              ...
              <div class="-mx-3 flex flex-wrap">
                <div class="w-full px-3 sm:w-7/12">
                  <div class="wow fadeInUp" data-wow-delay=".2s">
                    <p class="mb-4 text-base text-body">Popular Tags :</p>
          ...
          {{-- <section class="bg-white py-8 lg:py-16 antialiased">
            <div class="max-w-2xl mx-auto px-4">
                ...
                <div class="flex flex-col gap-5">
                  <div class="flex flex-col">
                    ...
                    <input
                      type="text"
                      id="name"
                      class="p-3 border border-gray-400 w-full rounded-lg"
              ...
              <article
                class="p-6 text-base bg-slate-100 rounded-lg"
              >
              ...
              <article
                class="p-6 mb-3 ml-6 lg:ml-12 text-base bg-slate-100 mt-5 rounded-lg "
              >
                <footer class="flex justify-between items-center mb-2">
                  ...
                  <button
                    ...
                    class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 dark:text-gray-40 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-900/15 dark:hover:bg-gray-700/10 "
                    type="button"
                  >
                    <svg
                      class="w-4 h-4"
              ...
              <article
                class="p-6 text-base bg-slate-100 rounded-lg mt-2"
              >
                <div class="flex justify-between items-center mb-2">
                  <div class="flex items-center">
                    <p
            ...
            <li class="pb-6 mb-6 border-b border-gray-200">
              <div class="flex items-center lg:block xl:flex">
                ...
                <div class="w-full">
                  <h5>
                    <a
                      href="{{ route('blog.details',['slug'=>$related->slug]) }}"
